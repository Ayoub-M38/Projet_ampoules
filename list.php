    ...
    <table class="table mt-5">
        ...
        foreach ($bulbs as $bulb) :
            ...
            <tr>
                ...
                <td>
                    <img src="<?php echo $bulb['image'] ?>" class="thumb-image">
                </td>
                ...
                <td>
                    <button type="button" class="btn btn-sm btn-success" data-toggle="modal"
                            data-target="#detailsAmpoule<?= $bulb['id_ampoule'] ?>">
                        Détails de l'opération
                    </button>

                    <!-- Modal -->
                    <div class="modal fade" id="detailsAmpoule<?= $bulb['id_ampoule'] ?>" tabindex="-1" role="dialog"
                         aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Détail de l'opération
                                        N° <?= $bulb['id_ampoule'] ?></h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <div class="text-center">
                                        <img class="update-image" src="<?php echo $bulb['image'] ?>">
                                    </div>
                                    <ul>
                ...
                <td>
                    <button type="button" class="btn btn-sm btn-warning" data-toggle="modal"
                            data-target="#update<?= $bulb['id_ampoule'] ?>">
                        Mise a jour de l'opération
                    </button>

                    <div class="modal fade" id="update<?= $bulb['id_ampoule'] ?>" tabindex="-1" role="dialog"
                         aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Mise a jour de l'opération
                                        ID# <?= $bulb['id_ampoule'] ?></h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <form action="update.php?id=<?= $bulb['id_ampoule'] ?>" method="post"
                                        ...
                                        <div class="form-group">
                                            <label for="date_changement">Date de l'opération :</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="<?= $bulb['prix_ampoule'] ?>" step="any"
                                                   class="form-control" name="prix_ampoule" id="prix_ampoule">
                                        </div>

                                        <div class="form-group">
                                            <button type="submit" class="btn btn-info">Mettre a jour l'opération
                                            </button>
                                        </div>
                ...
                <td>
                    <button type="button" class="btn btn-sm btn-danger" data-toggle="modal"
                            data-target="#delete<?= $bulb['id_ampoule'] ?>">
                        Supprimer l'opération
                    </button>

                    <div class="modal fade" id="delete<?= $bulb['id_ampoule'] ?>" tabindex="-1" role="dialog"
                         aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    <a href="delete.php?id_delete=<?= $bulb['id_ampoule'] ?>" class="btn btn-danger">SUPPRIMER
                                        CETTE OPÉRATION</a>
                                </div>
                                <div class="modal-footer">
